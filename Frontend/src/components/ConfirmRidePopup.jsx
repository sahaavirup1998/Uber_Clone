      ...
      <div className="flex gap-2 justify-between items-center flex-col">
        ...
        <div className="w-full mt-4">
          <form onSubmit={handleSubmit}>
            ...
            />
            <button className="w-full flex justify-center mt-5 bg-green-500 text-white p-3 rounded-lg text-lg font-semibold">
              Confirm
            </button>
            <button
              onClick={() => {
              ...
              className="w-full mt-1 bg-red-600 text-white text-lg p-3 rounded-lg font-semibold"
            >
              Cancel
            </button>
          </form>
