...
const VehiclePanel = (props) => {
  return (
    <div>
        ...
        <div onClick={() => {
        ...
        }} className='w-full border-2 active:border-black rounded-xl flex items-center justify-between p-3 mb-2'>
          ...
          <h2 className='font-semibold text-lg'>₹{props.fare?.car ?? "200"}</h2>
        </div>
        <div onClick={() => {
          props.setConfirmRidePanel(true)
          ...
          <h2 className='font-semibold text-lg'>₹{props.fare?.motorcycle ?? "100"}</h2>
        </div>
        <div onClick={() => {
          props.setConfirmRidePanel(true)
          ...
          <h2 className='font-semibold text-lg'>₹{props.fare?.auto ?? "150"}</h2>
        </div>
    </div>
  )
}
